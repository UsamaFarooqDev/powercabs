...
<section class="tw-px-4 tw-pb-3 tw-pt-16 tw-text-center sm:tw-px-6 md:tw-pt-24 lg:tw-px-8">
  <div class="tw-mx-auto tw-inline-flex tw-w-full tw-max-w-[1320px] tw-flex-wrap tw-justify-center tw-gap-2">
    ...
    <label class="tw-inline-flex tw-cursor-pointer tw-items-center tw-rounded-full tw-border tw-border-solid tw-border-ink/20 tw-px-5 tw-py-2 tw-text-sm tw-font-semibold tw-text-ink tw-transition-colors tw-duration-200 has-[:checked]:tw-border-power has-[:checked]:tw-bg-power has-[:checked]:tw-text-white" for="tcAudiencePassenger">
      <input type="radio" class="tw-sr-only" name="tcAudience" id="tcAudiencePassenger" autocomplete="off" checked>
      Passenger Terms
    </label>
    <label class="tw-inline-flex tw-cursor-pointer tw-items-center tw-rounded-full tw-border tw-border-solid tw-border-ink/20 tw-px-5 tw-py-2 tw-text-sm tw-font-semibold tw-text-ink tw-transition-colors tw-duration-200 has-[:checked]:tw-border-power has-[:checked]:tw-bg-power has-[:checked]:tw-text-white" for="tcAudienceDriver">
      <input type="radio" class="tw-sr-only" name="tcAudience" id="tcAudienceDriver" autocomplete="off">
      Driver Terms
    </label>
  </div>
</section>
...
<!-- ============ Passenger Terms ============ -->
<section class="tw-px-4 tw-pb-16 tw-pt-3 sm:tw-px-6 md:tw-pb-24 lg:tw-px-8" id="passengerTerms">
  <div class="tw-mx-auto tw-w-full tw-max-w-[1320px]">
    <div class="tw-grid tw-grid-cols-1 tw-gap-12 lg:tw-grid-cols-12">
      ...
      <div class="tw-max-w-[72ch] tw-leading-[1.75] [&_h2]:tw-scroll-mt-[100px] [&_h2]:tw-text-ink [&_p]:tw-text-ink/[0.65] [&_ul]:tw-text-ink/[0.65] lg:tw-col-span-9">
        <p class="tw-mb-4 tw-text-sm tw-text-ink/50">Terms and Conditions for Passengers of PowerCabs Ireland Limited</p>
        ...
        <div class="tw-bg-peach tw-shadow-[0_8px_20px_rgba(28,20,16,0.12)] tw-my-4 tw-rounded-2xl tw-p-6">
          <p class="tw-mb-2 tw-font-semibold">Promotions &amp; Discount</p>
          <p class="tw-mb-2 tw-text-sm">The promo code is intended to help new passengers join. Each coupon can receive a maximum amount of 6 euros for each trip. Coupons expire on January 31, 2025 at 23:59. After this date and time, no discounts will be offered under this coupon. The coupon is limited to 20 trips per passenger. The company reserves the right to amend or cancel without prior notice.</p>
          <p class="tw-mb-0 tw-text-sm tw-font-semibold">Coupon Code: 01IRL2025PCLI</p>
        </div>

        <h2 id="p-offerings" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">1. PowerCabs Offerings</h2>
        ...
        <h2 id="p-mobility" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">2. Mobility Services Overview</h2>
        ...
        <h2 id="p-location" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">3. Utilizing Location Data</h2>
        ...
        <h2 id="p-fees" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">4. Fees for Technology Use and Trip Cancellations</h2>
        ...
        <h2 id="p-interrupt" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">5. Changes and Service Interruptions</h2>
        ...
        <h2 id="p-payment" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">6. Payment Procedures and App-Based Transactions</h2>
        ...
        <h2 id="p-payoptions" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">7. Payment Options and Policies</h2>
        ...
        <h2 id="p-subscription" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">8. Subscription Offerings</h2>
        ...
        <h2 id="p-duration" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">9. Duration and Discontinuation</h2>
        ...
        <h2 id="p-liability" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">10. Liability and Ownership of Creative Content</h2>
        ...
        <h2 id="p-conduct" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">11. User Conduct and Responsibilities</h2>
        ...
        <h2 id="p-validity" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">12. Validity, Jurisdiction, and Consumer Rights</h2>
...
<!-- ============ Driver Terms ============ -->
<!-- tw-hidden stays bare -- pcInitTermsConditions() in terms-conditions.js
     toggles it directly via classList. -->
<section class="tw-px-4 tw-pb-16 tw-pt-3 sm:tw-px-6 md:tw-pb-24 lg:tw-px-8 tw-hidden" id="driverTerms">
  <div class="tw-mx-auto tw-w-full tw-max-w-[1320px]">
    <div class="tw-grid tw-grid-cols-1 tw-gap-12 lg:tw-grid-cols-12">
      <div class="lg:tw-col-span-3">
        <div class="tw-sticky tw-top-[100px]">
      ...
      <div class="tw-max-w-[72ch] tw-leading-[1.75] [&_h2]:tw-scroll-mt-[100px] [&_h2]:tw-text-ink [&_p]:tw-text-ink/[0.65] [&_ul]:tw-text-ink/[0.65] lg:tw-col-span-9">
        <p class="tw-mb-4 tw-text-sm tw-text-ink/50">General Terms of Use &mdash; PowerCabs Ireland Limited Driver App for Taxi Drivers and Taxi Contractors of PowerCabs Ireland Limited (hereinafter: &ldquo;POWERCABS IRELAND LIMITED&rdquo;), CRO No. 764330.</p>

        <h2 id="d-scope" class="tw-mb-3 tw-mt-8 tw-text-2xl tw-font-bold">Scope and Main Terms</h2>
        ...
        <h2 id="d-avail" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">2. Availability</h2>
        ...
        <h2 id="d-obligations" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">3. General Contractual Obligations of the User</h2>
        ...
        <h2 id="d-software" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">4. Software</h2>
        ...
        <h2 id="d-content" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">5. Responsibility for Content</h2>
        ...
        <h2 id="d-tracking" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">6. Tracking, Third-Party Information</h2>
        ...
        <h2 id="d-exclusion1" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">7. Exclusion from Use, Rating System and Ranking, Payments</h2>
        ...
        <h2 id="d-termination" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">8. Termination</h2>
        ...
        <h2 id="d-exclusion2" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">9. Exclusion from Use</h2>
        ...
        <h2 id="d-liability" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">10. Liability</h2>
        ...
        <h2 id="d-data" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">11. Data Protection</h2>
        <p>Users acknowledge and accept that personal data will be collected, processed, and used in connection with any intermediation services provided through the Driver App, in accordance with the GDPR and relevant national laws. POWERCABS IRELAND LIMITED&rsquo;s Privacy Notice applies to such processing and is available on the <a class="tw-text-power tw-transition-colors tw-duration-200 hover:tw-text-powerdark focus-visible:tw-text-powerdark" href="<?= $assetPath ?>/privacy-policy">Privacy Policy</a> page.</p>

        <h2 id="d-complaints" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">12. Complaints</h2>
        ...
        <h2 id="d-final" class="tw-mb-3 tw-mt-10 tw-text-2xl tw-font-bold">13. Final Provisions</h2>
