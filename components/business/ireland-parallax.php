<section class="pc-biz-ireland position-relative overflow-hidden text-white text-center" id="pcBizIreland">
  ...
  <div class="container position-relative">
    ...
    <h2 class="mx-auto mb-3" style="max-width: 34ch; font-size: clamp(2.3rem, 5vw, 3.75rem);">
      Built for Dublin.<br>Trusted Across Ireland.
    </h2>
    <p class="mx-auto mb-0" style="max-width: 58ch; color: rgba(255,255,255,.92); font-size: 1.3rem;">
      NTA-licensed and Garda-vetted, with drivers who know Dublin's streets, its
      airport runs and its business districts -- so every journey your company
      books arrives exactly when it should.
    </p>
  </div>
</section>
