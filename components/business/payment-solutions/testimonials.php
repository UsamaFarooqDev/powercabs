<section
  class="section-pc overflow-hidden"
...
>
  <div class="container">
    ...
    <div class="text-center mx-auto mb-5" style="max-width: 720px;">
      ...
      <div
        class="d-inline-flex align-items-center gap-2 px-3 py-2 rounded-pill mb-3"
        style="
      ...
      <p
        class="text-muted-pc mb-0 mx-auto"
        style="
          max-width: 600px;
          font-size: 16px;
          line-height: 1.7;
  ...
  <div class="pc-marquee">
    ...
    <div class="pc-marquee-track py-3">
      ...
      <?php foreach ($marqueeItems as $i => $t): ?>
        ...
        <div
          class="pc-marquee-card px-2"
          <?= $i >= count($paymentTestimonials) ? 'aria-hidden="true"' : '' ?>
        >

          <article
            class="card h-100 border-0 bg-white position-relative overflow-hidden"
            style="
              width: 360px;
              min-height: 290px;
              border-radius: 22px;
              box-shadow: 0 10px 35px rgba(20,25,35,.07);
            "
          >
            ...
            <div class="card-body d-flex flex-column p-4">
              ...
              <!-- Customer -->
              <div
                class="mt-auto pt-3 border-top d-flex align-items-center gap-3"
              >

                <img
                  src="<?= $assetPath ?>assets/img/<?= $t['img'] ?>"
  ...
  <div class="container">
    ...
    <div
      class="d-flex flex-column flex-sm-row align-items-center justify-content-center gap-2 gap-sm-3 mt-4 text-center"
    >
      ...
      <span class="text-muted-pc small">
        Trusted by drivers and businesses across Ireland
      </span>
