  ...
  <div class="pc-app-promo-container position-relative">
    <div class="row align-items-center gy-5">
      ...
      <div class="col-lg-6 order-lg-2">
        ...
        <p class="mb-4" style="max-width: 46ch; color: rgba(28, 20, 16, 0.72);">
...
<div class="col-lg-6 order-lg-1 d-none d-lg-block">
  <div class="pc-app-showcase position-relative mx-auto" style="max-width: 300px;">
    <div class="pc-phone-frame pc-app-float-phone mx-auto position-relative">
      <div class="pc-phone-screen">
        <img src="<?= $assetPath ?>assets/img/download-app.jpeg" alt="PowerCabs app screen showing a route from Dublin Airport to Temple Bar" class="w-100 h-100" style="object-fit: cover;" loading="lazy">
      </div>
    </div>
