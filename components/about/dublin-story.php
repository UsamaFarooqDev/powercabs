<section class="section-pc">
  <div class="container">
    ...
    <div class="pc-story-masonry d-grid">
      ...
      <div class="pc-story-item-2 pc-story-card p-4 bg-white">
        <span class="pc-story-star-icon d-inline-flex align-items-center justify-content-center rounded-circle text-primary flex-shrink-0 mb-3"><i class="bi bi-star-fill"></i></span>
      ...
      <div class="pc-story-item-5 pc-story-card-orange d-flex flex-column align-items-center justify-content-center p-4 text-center text-white">
      ...
      <div class="pc-story-item-6 pc-story-card p-4 bg-white">
        ...
        <div class="pc-story-progress overflow-hidden"></div>
      </div>
    </div>
  </div>
</section>
