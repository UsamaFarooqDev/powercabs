...
<section class="section-pc position-relative overflow-hidden">
  <div class="container position-relative" style="z-index: 1;">
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <div class="row row-cols-2 g-3">
          ...
          <?php foreach ($bookingSteps as $step): ?>
            <div class="col">
              <div
                class="pc-story-card rounded-4 py-5 px-4 bg-white h-100 text-start position-relative overflow-hidden border-0">
      ...
      <div class="col-lg-6 d-none d-lg-flex p-5 align-items-center justify-content-center">
        <img src="<?= $assetPath ?>assets/img/booking-ride.png" class="img-fluid" style="max-width: 420px;"
          alt="Book your ride">
      </div>
    </div>
  </div>
        ...
        <div class="bg-white rounded-5 p-3 p-md-5" style="box-shadow: var(--pc-shadow-lg);">
          ...
          <form method="post" action="" class="row g-3 pc-booking-form">
            ...
            <div class="col-md-6">
              ...
              <input type="email" class="form-control" id="brEmail" name="email"
                value="<?= htmlspecialchars($old['email']) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="brPhone">Phone Number</label>
              <input type="tel" class="form-control" id="brPhone" name="phone"
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="brPickup" name="pickup_location"
                value="<?= htmlspecialchars($old['pickup_location']) ?>" autocomplete="off" required>
              <div class="form-text text-danger d-none" id="brPickupWarning">Please choose a pickup address within
                Dublin.</div>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="brDropoff">Drop-off Location</label>
              <input type="text" class="form-control" id="brDropoff" name="dropoff_location"
                value="<?= htmlspecialchars($old['dropoff_location']) ?>" autocomplete="off" required>
              <div class="form-text text-danger d-none" id="brDropoffWarning">Please choose a drop-off address within
                Dublin.</div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12 d-none" id="pcFareEstimate">
              <div class="d-flex align-items-center flex-wrap gap-3 rounded-4 px-3 py-3"
                style="background: rgba(25, 135, 84, .1); border: 1px solid rgba(25, 135, 84, .25);">
                <span class="d-inline-flex align-items-center justify-content-center rounded-circle flex-shrink-0"
                  style="width: 40px; height: 40px; background: #198754;">
            ...
            <?php if ($formStatus === 'success'): ?>
              <div class="col-12">
                <div class="alert alert-success mb-0 mt-3" role="alert">Thanks -- your booking request has been sent.
                  We'll confirm shortly.</div>
              </div>
            <?php elseif ($formStatus === 'error'): ?>
              <div class="col-12">
                <div class="alert alert-danger mb-0 mt-3" role="alert"><?= htmlspecialchars($formError) ?></div>
              </div>
            <?php endif; ?>
          </form>
        </div>
