        ...
        <div class="bg-white rounded-5 p-3 p-md-5" style="box-shadow: var(--pc-shadow-md);">
          <form method="post" action="" enctype="multipart/form-data" class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="liName" name="name" value="<?= htmlspecialchars(
                $old['name'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="liEmail">Email Address</label>
              <input type="email" class="form-control" id="liEmail" name="email" value="<?= htmlspecialchars(
                $old['email'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="liPhone">Phone Number</label>
              <input type="tel" class="form-control" id="liPhone" name="phone" value="<?= htmlspecialchars(
                $old['phone'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="liTaxiNumber">Taxi Number</label>
              <input type="text" class="form-control" id="liTaxiNumber" name="taxi_number" value="<?= htmlspecialchars(
                $old['taxi_number'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="liPickup">Pickup Location</label>
              <input type="text" class="form-control" id="liPickup" name="pickup_location" value="<?= htmlspecialchars(
                $old['pickup_location'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="liDropoff">Destination Location</label>
              <input type="text" class="form-control" id="liDropoff" name="destination_location" value="<?= htmlspecialchars(
                $old['destination_location'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label pc-required" for="liDate">Date / Time</label>
              <input type="datetime-local" class="form-control pc-custom-datetime-enhance" id="liDate" name="journey_datetime" value="<?= htmlspecialchars(
                $old['journey_datetime'],
              ) ?>" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control" id="liItem" name="item_description" rows="4" required><?= htmlspecialchars(
                $old['item_description'],
              ) ?></textarea>
            </div>
